  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      child: ListTile(
        ...
        title: Text(user.displayName, style: TextStyle(fontFamily: 'SF Pro Rounded', fontSize: 11.sp, fontWeight: FontWeight.w700)),
        subtitle: Text(user.handle ?? '', style: TextStyle(fontFamily: 'SF Pro Rounded', fontSize: 11.sp, fontWeight: FontWeight.w400, color: Color(0xFF6B7280))),
        onTap: () {
