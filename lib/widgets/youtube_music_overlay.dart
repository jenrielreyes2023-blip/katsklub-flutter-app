...
/// Inspired by the official YouTube Music mobile app:
/// - Expands into a full-screen music player.
/// - Minimizes into a sleek bottom mini-player bar when browsing Feed, Chat, or Profile.
/// - Never stops playing when switching tabs or screens!
...
class _YouTubeMusicOverlayState extends State<YouTubeMusicOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: _controller.isMinimized,
      onPopInvokedWithResult: (didPop, _) {
        if (!didPop && !_controller.isMinimized) {
          _controller.minimize();
        }
      },
      child: _controller.isMinimized
          ? _buildBottomMiniBar(track)
          : _buildFullScreenPlayer(track),
    );
  }

  /// Sleek YouTube Music Bottom Mini-Player Bar
  Widget _buildBottomMiniBar(dynamic track) {
    final bottomPadding = MediaQuery.of(context).padding.bottom;

    return Positioned(
      left: 12.w,
      right: 12.w,
      bottom: bottomPadding + 58.h, // Sits comfortably above the BottomNavBar
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16.r),
              border: Border.all(color: const Color(0x33FF2A6D), width: 1.2),
              boxShadow: [
                BoxShadow(
            ...
            child: Row(
              children: [
                // Hidden webview keeps running audio continuously
                      ...
                      Row(
                        children: [
                          const Icon(Icons.music_note_rounded,
                              color: Color(0xFFFF2A6D), size: 12),
                          SizedBox(width: 3.w),
                          Expanded(
                            child: Text(
                              track.author,
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // Player Screen (Interactive Clean WebView)
              Padding(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // Continuous Background Play Badge
                    Container(
